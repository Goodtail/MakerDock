...
The app is ad-hoc signed for local execution; Apple portal resources are not required for this command. Configured personal team is `YOUR_PERSONAL_TEAM_ID`; no company account is used.
