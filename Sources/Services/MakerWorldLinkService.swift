...
enum MakerWorldLinkPolicy {
    ...
    static func parse(_ incoming: URL) throws -> Source {
        ...
        if scheme == "bambustudioopen" {
        ...
        } else if scheme == "bambustudio" || ["makerdock", "plateshelf", "makerdock-dev", "plateshelf-dev"].contains(scheme) {
            ...
            if ["makerdock", "plateshelf", "makerdock-dev", "plateshelf-dev"].contains(scheme) {
